...
public class Money implements Comparable {
	...
	public String toString() {
		return (this.amount / 100) + "." + (this.amount % 100) + " " + this.currency.getName();
	}
	...
	public Boolean equals(Money other) {
		Integer thisValue = this.universalValue();
		Integer otherValue = other.universalValue();
	...
	public Money add(Money other) {
		int otherAmountInThisCurrency = (int)(other.amount * other.currency.getRate() / this.currency.getRate());
		return new Money(this.amount + otherAmountInThisCurrency, this.currency);
	}
